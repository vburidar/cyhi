...
function getLengthRest(event: any, currentInterval: any)
{
	...
	//echo "CURRENT INTERVAL RAW = " . $current_interval['raw'] . "</br>";
...
function convertRest(event: any, track: any, currentInterval: any, lengthTrack: number)
{
	...
	//echo "PREVIOUS_INTERVAL = " . $previous_interval . "</br>";
	//echo "NEXT_INTERVAL = " . $current_interval['refined'] . "</br>";
    ...
    //track: substr_replace(track, ret, -previousInterval.length)
}
